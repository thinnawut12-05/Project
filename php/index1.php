...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css"
    integrity="sha384-k6RqeWeci5ZR/Lv4MR0sA0FfDOM7z4j8e+Q1z5l5x5l5x5l5x5l5x5l5x" crossorigin="anonymous" />
...
<body>
  <header>
    ...
    <nav>
      <a href="./type.html">ประเภทห้องพัก</a>
      <a href="./branch.html">สาขาโรงแรมดอม อินน์</a>
      <a href="./details.html">รายละเอียดต่างๆ</a>
      <a href="#">การจองของฉัน</a>
      <a href="#">คะแนน</a>
    </nav>
    <nav>
      <a href="./member.html">สมัครสมาชิก</a>
  ...
  <section class="booking-form">
    <select id="region" onchange="updateBranches()">
      ...
      <option value="north">ดอมอินน์ ภูมิภาคเหนือ</option>
      <option value="central">ดอมอินน์ ภูมิภาคกลาง</option>
      <option value="northeast">ดอมอินน์ ภูมิภาคตะวันออกเฉียงเหนือ</option>
      <option value="west">ดอมอินน์ ภูมิภาคตะวันตก</option>
      <option value="south">ดอมอินน์ ภูมิภาคใต้</option>
    </select>
    ...
    <input id="date-range" type="text" placeholder="วันที่เช็คอิน - วันที่เช็คเอ้าท์" readonly
    ...
    <div class="guest-selector">
      ...
      <div class="guest-group">
        <span>ห้องพัก</span>
        <button type="button" onclick="changeGuest('room', -1)">–</button>
