...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 01, 2025 at 05:00 PM
...
CREATE TABLE `reservation` (
  ...
  `Officer_confirmed` tinyint(1) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `reservation` (`Reservation_Id`, `Guest_name`, `Number_of_rooms`, `Booking_time`, `Number_of_adults`, `Number_of_children`, `Booking_date`, `Check_out_date`, `Email_Admin`, `Province_Id`, `Email_member`, `receipt_image`, `Booking_status_Id`, `stars`, `comment`, `Notified`, `Officer_confirmed`) VALUES
('1758791367', 'สมหญิง ใจเกร่ง', 1, '2025-09-25', 1, 0, '2025-09-25', '2025-09-30', 'admin1@example.com', NULL, 'user5@gmail.com', 'receipt_68d506c7eafff4.39818231.jpg', '3', NULL, NULL, 1, 0),
('1758791492', 'สมหญิง ใจเกร่ง', 2, '2025-09-25', 4, 0, '2025-09-28', '2025-09-30', 'admin1@example.com', NULL, 'user5@gmail.com', 'receipt_68d507449eda32.91105228.jpg', '3', NULL, NULL, 1, 0),
('1758793841', 'สมดี สองใจ', 1, '2025-09-25', 1, 0, '2025-09-28', '2025-09-30', 'admin1@example.com', '1', 'user1@gmail.com', 'receipt_68d510716404c7.24057011.jpg', '3', 5, 'ดีมาก', 1, 0),
('1758793984', 'สมดี สองใจ', 1, '2025-09-25', 1, 0, '2025-09-28', '2025-09-30', NULL, '1', 'user1@gmail.com', 'receipt_68d51100d5bea5.98156340.jpg', '5', NULL, NULL, 1, 0),
('1758902148', 'สมดี ผกดเหกเ', 1, '2025-09-26', 1, 0, '2025-09-27', '2025-09-30', 'admin1@example.com', '1', 'user4@gmail.com', 'receipt_68d6b784f33d15.31566633.jpg', '3', NULL, NULL, 1, 0),
('1759324590', 'สมดี สองใจ', 1, '2025-10-01', 1, 0, '2025-10-01', '2025-10-03', NULL, '1', 'user1@gmail.com', 'receipt_68dd29ae081522.24247104.jpg', '3', NULL, NULL, 0, 0);
