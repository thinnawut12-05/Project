...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 23, 2025 at 06:28 PM
...
('admin1@example.com', 'password123', 'Mr.', 'Somchai', 'Sukhum', 'Male', '0812345678'),
('admin2@example.com', 'password456', 'Ms.', 'Suda', 'Chaiya', 'Fema', '0898765432'),
('admin3@example.com', 'admin789', 'Mrs.', 'Naree', 'Wong', 'Fema', '0823456789');
...
INSERT INTO `reservation` (`Reservation_Id`, `Guest_name`, `Number_of_rooms`, `Booking_time`, `Number_of_adults`, `Number_of_children`, `Booking_date`, `Check_out_date`, `Email_Admin`, `Email_member`, `Receipt_Id`, `Booking_status_Id`) VALUES
('1758609445', 'จงกอน ปาร์ต', 1, '2025-09-23', 1, 0, '2025-09-23', '2025-09-30', NULL, 'user3@gmail.com', NULL, '2'),
('1758615715', 'สมหญิง ใจเกร่ง', 1, '2025-09-23', 1, 0, '2025-09-30', '2025-10-03', NULL, 'user5@gmail.com', NULL, '2'),
('1758644874', 'สมดี สองใจ', 2, '2025-09-23', 4, 2, '2025-09-23', '2025-10-01', NULL, 'user1@gmail.com', NULL, '2');
